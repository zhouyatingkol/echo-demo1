...
import { resolveProjectRoot, HardhatRuntimeEnvironmentImplementation, } from "./core/hre.js";
import { resolvePluginList } from "./core/plugins/resolve-plugin-list.js";
import { getGlobalHardhatRuntimeEnvironment, setGlobalHardhatRuntimeEnvironment, } from "./global-hre-instance.js";
/**
 ...
 */
export async function createHardhatRuntimeEnvironment(config, userProvidedGlobalOptions = {}, projectRoot, unsafeOptions = {}) {
    ...
    if (unsafeOptions.resolvedPlugins === undefined) {
        ...
        const resolvedPlugins = await resolvePluginList(resolvedProjectRoot, plugins);
        unsafeOptions.resolvedPlugins = resolvedPlugins;
    }
    if (unsafeOptions.globalOptionDefinitions === undefined) {
        const pluginGlobalOptionDefinitions = buildGlobalOptionDefinitions(unsafeOptions.resolvedPlugins);
 ...
 */
export async function getOrCreateGlobalHardhatRuntimeEnvironment() {
    ...
    globalHre = await createHardhatRuntimeEnvironment(userConfig, { config: configPath }, projectRoot);
    setGlobalHardhatRuntimeEnvironment(globalHre);
    return globalHre;
}
//# sourceMappingURL=hre-initialization.js.map