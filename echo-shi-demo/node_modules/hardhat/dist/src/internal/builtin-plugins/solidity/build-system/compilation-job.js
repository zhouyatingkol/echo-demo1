...
export class CompilationJobImplementation {
    ...
    #buildId;
    #solcInput;
    constructor(dependencyGraph, solcConfig, solcLongVersion, hooks, sharedContentHashes = new Map()) {
    ...
    async #buildSolcInput() {
        ...
        outputSelection["*"]["*"].push("abi", "evm.bytecode", "evm.deployedBytecode", "evm.methodIdentifiers", "metadata");
        const sources = {};
