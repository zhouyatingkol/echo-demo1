 ...
 */
export function printErrorMessages(error, shouldShowStackTraces = false, print = console.error) {
    ...
    const { formattedErrorMessage, showMoreInfoMessage, postErrorStackTraceMessage, } = getErrorMessages(error);
...
function getErrorWithCategory(error) {
...
function printUsingHardhat2Error(error, print = console.error) {
