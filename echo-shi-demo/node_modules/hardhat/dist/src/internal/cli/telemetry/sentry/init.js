...
export function init(options) {
    const client = initAndBind(ServerRuntimeClient, {
        dsn: options.dsn,
...
function createUnhandledErrorListener(client, isPromiseRejection) {
...
function setupGlobalUnhandledErrorHandlers(client) {
