...
const contractJson = JSON.parse(
    fs.readFileSync('./artifacts/contracts/ECHOFusion.sol/ECHOFusion.json', 'utf8')
);
...
async function deploy() {
    try {
        ...
        fs.writeFileSync('deployment-fusion-mainnet.json', JSON.stringify(deploymentInfo, null, 2));
        console.log('\n💾 部署信息已保存到 deployment-fusion-mainnet.json');
